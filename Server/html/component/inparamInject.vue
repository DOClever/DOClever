<template>
    <el-row class="row">
        ...
        <el-input style="margin-top: 10px" v-model="obj.before.code" type="textarea" :rows="8" v-if="type==0" placeholder="请输入你需要在运行前注入的JS代码" :disabled="true">

        </el-input>
        <el-input style="margin-top: 10px" v-model="obj.after.code" type="textarea" :rows="8" v-else placeholder="请输入你需要在运行后注入的JS代码" :disabled="true">
