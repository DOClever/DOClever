<template>
    <el-row class="row">
        ...
        <el-row class="row" style="height: calc(100vh - 214px);margin-top: 5px">
...
<script>
    ...
    module.exports = {
        ...
        created:function () {
            window.store.state.event.$on("testRunStatus",this.setStatus)
            window.store.state.event.$on("testCollectionRun",this.setInfo)
        },
        beforeDestroy:function () {
            window.store.state.event.$off("testRunStatus",this.setStatus)
            window.store.state.event.$off("testCollectionRun",this.setInfo)
        },
    }
</script>
