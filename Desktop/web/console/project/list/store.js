module.exports={
    ...
    getters:{
        ...
        rootInit:function (state,getters,rootState) {
            return window.store.state.init;
        },
    ...
    actions:{
        addProject:function (context,data) {
            ...
            var type=data.type;
            if(context.state.teamId)
            {
                query.team=context.state.teamId;
            }
            var pro;
            if(data.type=="interface")
            {
            ...
            else if(context.state.teamId)
            {
                return Promise.all([
                    ...
                    if(data1.code==200)
                    {
                        ...
                        global.store.state.event.$emit("updateTeamProjectList",context.state.projectTeamList);
                    }
                    else
                    {
                        throw data1.msg;
                    ...
                    if(data2.code==200)
                    {
                        ...
                        global.store.state.event.$emit("updateTeamDocList",context.state.docTeamList);
                    }
                    else
                    {
                        throw data2.msg;
                    ...
                    if(data3.code==200)
                    {
                        ...
                        global.store.state.event.$emit("updateTeamTestList",context.state.testTeamList);
                    }
                    else
                    {
                        throw data3.msg;
                    ...
                    if(data4.code==200)
                    {
                        context.state.role=data4.data.role;
                    }
                    else
                    {
                        throw data4.msg;
        ...
        info:function (context,obj) {
            context.dispatch("changeToInfo",obj,{
                root:true
            });
        }
    }
