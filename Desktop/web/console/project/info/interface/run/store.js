...
module.exports={
    ...
    getters:{
        ...
        status:function (state,getters,rootState) {
            return state.rootInfo.state.status;
        },
    ...
    actions:{
        ...
        save:function (context) {
            ...
            context.commit("setNewInterfaceStr",JSON.stringify(obj),{
                root:true
            })
            var bMatchUrl=false;
            if(baseUrl!="MockServer")
            ...
            context.state.interface.param.forEach(function (obj) {
                ...
                if(obj.query.length>0)
                {
                    for(var i=0;i<obj.query.length;i++)
                    {
                        ...
                        {
                            var objStatus=null;
                            context.state.rootInfo.state.status.forEach(function (obj1) {
