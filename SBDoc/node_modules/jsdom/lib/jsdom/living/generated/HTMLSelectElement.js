...
const isHTMLOptionElement = require("./HTMLOptionElement").is;
const isHTMLOptGroupElement = require("./HTMLOptGroupElement").is;
const isHTMLElement = require("./HTMLElement").is;
