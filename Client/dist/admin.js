...
var page = __webpack_require__(30);
module.exports = {
    data: function data() {
        return {};
    },
...
var page = __webpack_require__(30);
var projectAdd = __webpack_require__(214);
var editProjectUser = __webpack_require__(216);
module.exports = {
    data: function data() {
        return {
            type: 0,
    ...
    methods: {
        edit: function edit(item, index) {
            ...
            net.get("/admin/project", {
                ...
                $.stopHud();
                if (data.code == 200) {
                    $.showBox(_this.$root, __webpack_require__(215), {
                        propObj: data.data
                    });
                } else {
                    $.notify(data.msg, 0);
...
var _roleOption = __webpack_require__(22);
module.exports = {
    data: function data() {
        return {
            savePending: false,
...
var roleOption = __webpack_require__(22);
var proxyImg = __webpack_require__(8);
module.exports = {
...
var page = __webpack_require__(30);
var teamAdd = __webpack_require__(217);
var teamUserEdit = __webpack_require__(219);
var teamProjectEdit = __webpack_require__(218);
module.exports = {
    data: function data() {
        return {
            type: 0,
...
var page = __webpack_require__(30);
var proxyImg = __webpack_require__(8);
var _userProject = __webpack_require__(220);
var _userTeam = __webpack_require__(221);
module.exports = {
    data: function data() {
        return {
            type: 0,
    ...
    methods: {
        create: function create() {
            $.showBox(this.$root, __webpack_require__(95));
        },
        edit: function edit(item, index) {
            var _this = this;
            $.startHud();
            net.get("/admin/userinfo", {
                ...
                $.stopHud();
                if (data.code == 200) {
                    $.showBox(_this.$root, __webpack_require__(95), {
                        propObj: data.data
                    });
                } else {
                    $.notify(data.msg, 0);
...
var imgFile = __webpack_require__(49);
module.exports = {
    props: ["propObj"],
    data: function data() {
        return {
...
/* WEBPACK VAR INJECTION */(function(Vue, net, $) {var mainNav=__webpack_require__(9)
var user=__webpack_require__(108)
var project=__webpack_require__(104)
var team=__webpack_require__(107)
var interface=__webpack_require__(103)
var setting=__webpack_require__(105)
var statistic=__webpack_require__(106)
