    ...
    methods: {
                ...
                $.confirm("确定退出该团队？你同时也会退出团队中的项目", function () {
                    ...
                    net.delete("/team/projectuser", {
                        ...
                        if (data.code == 200) {
                            if (data.data.length > 0) {
                                _this.deletePending = false;
                                var child = $.showBox(_this, __webpack_require__(151), {
                                    arr: data.data,
                                    user: session.get("id"),
                                    self: 1
                                });
        ...
        transfer: function transfer() {
            ...
            net.get("/team/user", {
                ...
                $.stopHud();
                if (data.code == 200) {
                    var child = $.showBox(_this, __webpack_require__(432), {
                        arr: data.data
                    });
                } else {
                    $.notify(data.msg, 0);
    ...
    methods: {
        ...
        user: function user(item) {
            ...
            net.get("/team/projectuser", {
                ...
                $.stopHud();
                if (data.code == 200) {
                    var child = $.showBox(_this, __webpack_require__(431), {
                        arr: data.data,
                        id: item._id
                    });
        ...
        transfer: function transfer(item, index) {
            ...
            net.get("/team/projectuser", {
                ...
                $.stopHud();
                if (data.code == 200) {
                    var child = $.showBox(_this, __webpack_require__(430), {
                        arr: data.data,
                        id: item._id
                    });
...
module.exports = {
    ...
    methods: {
        ...
        editRoleOption: function editRoleOption(item) {
            var _this = this;
            var child = $.showBox(this, __webpack_require__(24), {
                hudremove: true,
                data: item.option
            });
    ...
    methods: {
        ...
        setOwner: function setOwner(item) {
            ...
            net.get("/team/projectuser", {
                ...
                var child = $.showBox(_this, __webpack_require__(433), {
                    arr: data.data,
                    id: item._id
                });
...
var update = __webpack_require__(25)("13361019", content, false);
...
var teamInfo=__webpack_require__(167);
var teamProjectList=__webpack_require__(168);
var teamUser=__webpack_require__(169);
...
var vue=new Vue({
    ...
    methods:{
        ...
        importProject:function () {
            $.showBox(this,__webpack_require__(54));
        },
        addGroup:function () {
            var _this=this;
            $.input("请输入部门名称",function (val) {
...
var bus = __webpack_require__(119);
module.exports = {
    data: function data() {
        return {
            type: 0,
