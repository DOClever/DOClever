<template>
    <el-dialog title="新建项目"  size="large" ref="box" v-model="showDialog">
        <el-form ref="form" label-width="100px">
            <el-form-item label="名称" style="text-align: center">
                <el-input  style="width: 80%" name="name" v-model="obj.name" placeholder="请输入项目名称"></el-input>
            </el-form-item>
            <el-form-item label="描述" style="text-align: center">
                <el-input type="textarea" :rows="3"  style="width: 80%" name="dis" v-model="obj.dis" placeholder="请输入项目描述"></el-input>
            </el-form-item>
            ...
            <el-form-item label="所有者" style="text-align: center">
                <el-autocomplete :fetch-suggestions="querySearchAsync.bind(this,0)" style="width: 80%" name="owner" v-model="obj.owner.name" placeholder="请输入所有者名称" @select="sel"></el-autocomplete>
            </el-form-item>
                ...
                <template v-for="(item,index) in obj.users">
                    <el-row class="row" style="height: 50px;line-height: 50px;width: 90%;display: inline-block">
                        <el-col :span="12" class="col">
                            <el-autocomplete :fetch-suggestions="querySearchAsync.bind(this,index)" style="width: 80%" v-model="item.name" @input="index==obj.users.length-1?add():''" placeholder="请输入用户名称" @select="selUser"></el-autocomplete>
                        </el-col>
                        <el-col :span="6" class="col">
                            <el-select v-model="item.role" style="width: 80%">
                                <el-option label="管理员" :value="0"></el-option>
                                <el-option label="观察者" :value="1"></el-option>
                            </el-select>
                        </el-col>
                        <el-col :span="4" class="col">
                            <el-button type="text" v-if="item.role==1" @click="roleOption(item,index)">
                                权限
                            </el-button>
                        </el-col>
                        <el-col :span="2" class="col">
                            <el-button type="text" icon="close" style="color: red" @click="remove(item,index)">
                            </el-button>
                        </el-col>
                    </el-row>
                </template>
