<template>
    <el-dialog title="管理用户"  size="large" ref="box" v-model="showDialog">
        <el-row class="row" style="height: 50px;line-height: 50px;text-align: center">
            ...
            <el-col class="col" :span="4">
                <el-button type="text" style="font-size: 15px;width:40px;height: 50px" title="添加部门" @click="addGroup">
                    添加部门
                </el-button>
            </el-col>
        </el-row>
                        ...
                        <el-row class="row" style="height: 40px;line-height: 40px;text-align: center" :key="item1.user._id">
                            ...
                            <el-col class="col" :span="6">
                                <template v-if="item1.role!=2">
                                    <el-select v-model="item1.role" @input="changeRole(item1)">
        ...
        <el-dialog title="选择部门" v-model="showGroup" size="small" :modal="0">
