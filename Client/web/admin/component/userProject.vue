<template>
    <el-dialog title="用户项目"  size="large" ref="box" v-model="showDialog">
        <el-tabs type="card">
                ...
                <table class="table-hover" style="width: 100%;">
                    ...
                    <template v-for="(item,index) in obj.own">
                        <tr style="height: 50px;text-align: center;vertical-align: middle">
                            ...
                            <td style="width: 10%">
                                <el-button type="text" @click="transfer(item,index)" title="转让"><i class="fa fa-sign-in"></i></el-button>&nbsp;&nbsp;
                                <el-button type="text" icon="close" style="color: red" @click="remove(item,index)" title="删除"></el-button>
                            </td>
                        </tr>
                    </template>
                </table>
                ...
                <table class="table-hover" style="width: 100%;">
                    ...
                    <template v-for="(item,index) in obj.join">
                        <tr style="height: 50px;text-align: center;vertical-align: middle">
                            ...
                            <td style="width: 25%">
                                <el-select v-model="item.role" @input="role(item,index)" style="width: 60%">
                                    <el-option label="管理员" :value="0"></el-option>
                                    <el-option label="观察者" :value="1"></el-option>
                                </el-select>
                                &nbsp;
                                <el-button v-if="item.role==1" type="text" size="small" @click="roleOption(item,index)">权限</el-button>
                            </td>
                            <td style="width: 10%">
                                <el-button type="text" icon="close" style="color: red" @click="quit(item,index)" title="退出"></el-button>
                            </td>
                        </tr>
                    </template>
                </table>
