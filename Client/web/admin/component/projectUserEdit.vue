    ...
    <el-dialog title="管理用户"  size="large" ref="box" v-model="showDialog">
        <el-row class="row" style="height: 50px;line-height: 50px">
            ...
            <el-col class="col" :span="11" style="text-align: center">
                <el-input placeholder="输入新增的用户名" style="width: 80%" v-model="name"></el-input>
            </el-col>
            <el-col class="col" :span="4" style="text-align: center">
                <el-select style="width: 80%" v-model="role">
            ...
            <el-col class="col" :span="3" style="line-height: 50px;text-align: center">
                <el-button  style="font-size: 15px" size="small" @click="editOption" type="text" v-if="role==1">权限</el-button>
            </el-col>
            <el-col class="col" :span="3" style="line-height: 50px;text-align: center">
