<template>
    <el-dialog title="项目用户管理"  size="small" ref="box" v-model="showDialog">
                    ...
                    <el-collapse-item :title="item.name" class="hover">
                        <template v-for="(item1,index1) in item.users">
                            <el-row class="row" style="height: 40px;line-height: 40px;text-align: center">
                                ...
                                <el-col class="col" :span="3">
                                    <el-button  style="font-size: 15px" size="small" @click="editRoleOption(item1)" type="text" v-if="item1.role==1">权限</el-button>
                                </el-col>
                            </el-row>
                        </template>
                    </el-collapse-item>
