                    ...
                    <el-form ref="form" label-width="100px" v-if="session.versionId">
                        ...
                        <el-row class="row" style="text-align: center">
                            <el-col class="col" :span="8" style="text-align: center" >
                                <el-button type="primary" style="width: 80%;margin-top: 20px;margin-bottom: 20px" @click.prevent="saveVersion" :loading="savePending" v-if="versionEditRole">
                                    保存
                                </el-button>
                            </el-col>
                            <el-col class="col" :span="8" style="text-align: center">
                                <el-button type="danger" style="width: 80%;margin-top: 20px;margin-bottom: 20px" @click.prevent="rollVersion" :loading="rollPending" v-if="versionRollRole">
                                    回滚
                                </el-button>
                            </el-col>
                            <el-col class="col" :span="8" style="text-align: center">
                                <el-button type="danger" style="width: 80%;margin-top: 20px;margin-bottom: 20px" @click.prevent="removeVersion" :loading="removePending" v-if="versionEditRole">
                                    删除
                                </el-button>
                            </el-col>
                        </el-row>
                                        ...
                                        <td style="width:20%">
                                            <el-dropdown>
                                                ...
                                                <el-dropdown-menu slot="dropdown">
                                                    <el-dropdown-item @click.native="editIndex=index,editId=item._id,editName=item.version,editDis=item.dis,showEditVersion=true" v-if="versionEditRole">编辑</el-dropdown-item>
                                                    <el-dropdown-item @click.native="switchVersion(item,index)">切换</el-dropdown-item>
                                                    <el-dropdown-item @click.native="rollVersion(item,index)" style="color: red" v-if="versionRollRole">回滚</el-dropdown-item>
                                                    <el-dropdown-item @click.native="removeVersion(item,index)" style="color: red" v-if="versionEditRole">删除</el-dropdown-item>
                                                </el-dropdown-menu>
                                            </el-dropdown>
                                        </td>
                                    </tr>
...
<script>
    ...
    var store=require("../store")._modulesNamespaceMap["version/"].context;
