    ...
    <el-row class="row" style="margin:0 0 0 5px" :gutter="20">
        <el-col class="col" :span="7" style="background-color: white;box-shadow: 2px 2px 2px #888888;border-radius: 5px;margin: 0;padding: 0">
            <el-row class="row" style="height: 50px;background-color: #50bfff;color: white;margin: 0;padding: 0">
                ...
                <el-col :span="testEditRole?3:0" class="col" style="text-align: center;line-height: 50px;cursor: pointer;" @click.native="poll" title="轮询" v-if="testEditRole">
                    <i class="fa fa-clock-o"></i>
                </el-col>
                <el-col :span="testEditRole?3:9" class="col" style="text-align: center;line-height: 50px;cursor: pointer;" @click.native="setBaseUrl" title="设置BaseUrl">
                    <i class="fa fa-link"></i>
                </el-col>
                <el-col :span="testEditRole?3:0" class="col" style="text-align: center;line-height: 50px;cursor: pointer;" @click.native="addModule" title="添加模块" v-if="testEditRole">
                    <i class="el-icon-plus"></i>
                </el-col>
            </el-row>
            <testlist ref="tree" style="min-height: 300px;"></testlist>
            <el-row class="row" style="height: 50px;line-height: 50px;text-align: center;font-weight: bold;font-size: 15px;padding: 0;background-color: #50bfff;color: white">
                ...
                <el-row class="row" style="background-color: white;border-radius: 5px;box-shadow: 0px 2px 2px #888888;padding: 15px 0" >
                    <el-row class="row" style="height: 50px;line-height: 50px">
                        ...
                        <el-col class="col" :span="4" style="height: 50px;line-height: 50px;text-align: left">
                            <el-button :loading="savePending" type="primary" style="width: 65%" @click="save" v-if="testEditRole">
                                保存
                            </el-button>
                        </el-col>
                        <el-col class="col" :span="1" style="text-align: left">
...
<script>
    var store=require("../store")._modulesNamespaceMap["test/"].context;
