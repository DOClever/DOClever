<template>
    <el-dialog title="输入窗口" v-model="showDialog" size="small" ref="box" :close-on-click-modal="false">
        ...
        <el-row class="row" style="text-align: center">
            <el-input type="textarea" v-model="val" :rows="5" placeholder="请输入您需要返回的值"></el-input>
        </el-row>
