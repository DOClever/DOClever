<template>
    <el-dialog title="导入用户" v-model="showDialog"  size="small" ref="box" :close-on-click-modal="false">
        ...
        <table style="width: 100%;" class="table-hover">
            ...
            <template v-for="item in arr">
                <tr style="text-align: center;vertical-align: middle">
                    ...
                    <td style="width: 25%">
                        <el-select v-model="item.role" style="width: 90%" @input="changeRole(item)">
                            <el-option :value="1" label="观察者"></el-option>
                            <el-option :value="0" label="管理员"></el-option>
                        </el-select>
                    </td>
                    <td style="width: 10%">
                        <el-button  style="font-size: 15px" size="small" @click="editRoleOption(item)" type="text" v-if="item.role==1">权限</el-button>
                    </td>
                </tr>
            </template>
            </tbody>
