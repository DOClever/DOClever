<template>
    <el-dialog title="通知用户" v-model="showDialog"  size="small" ref="box" :close-on-click-modal="false">
        ...
        <el-row class="row" style="text-align:center ">
            <el-input type="textarea" style="width: 90%" :rows="3" v-model="text" placeholder="请填写你需要发送的信息"></el-input>
        </el-row>
