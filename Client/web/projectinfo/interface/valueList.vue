<template>
    <el-dialog title="编辑值"  size="small" ref="box" v-model="showDialog">
        <el-row class="row">
                ...
                <template v-for="(item,index) in info.data">
                    <tr style="text-align: center;vertical-align: middle;height: 50px">
                        <td style="width: 40%;text-align: center;vertical-align: middle;">
                            <el-input style="width: 95%" v-model="item.value" placeholder="请输入可能的值"></el-input>
                        </td>
                        <td style="width: 50%;text-align: center;vertical-align: middle;">
                            <el-input style="width: 95%" v-model="item.remark" placeholder="请输入备注"></el-input>
                        </td>
