            ...
            <el-dropdown trigger="hover" style="margin-left: 15px">
                <div class="el-dropdown-link">
                    <el-button size="mini" type="primary">
                        接口/用例&nbsp;<i class="el-icon-caret-bottom
"></i>
                    </el-button>
                </div>
                <el-dropdown-menu slot="dropdown">
                    <el-dropdown-item @click.native="insertInterface">接口</el-dropdown-item>
                    <el-dropdown-item @click.native="insertTest">用例</el-dropdown-item>
                </el-dropdown-menu>
            </el-dropdown>
            <el-dropdown trigger="hover" style="margin-left: 15px">
                <div class="el-dropdown-link">
...
"></i>
                ...
                <el-dropdown-menu slot="dropdown">
                    <el-dropdown-item @click.native="insertLog">log</el-dropdown-item>
                    <el-dropdown-item @click.native="insertInput">input</el-dropdown-item>
                    <el-dropdown-item @click.native="insertBaseUrl">BaseUrl</el-dropdown-item>
                </el-dropdown-menu>
            </el-dropdown>
...
" style="color: orange" v-else-if="item.status==4"></i>
                    ...
                    <el-col class="col" :span="7">
                        <template v-if="item.type=='interface'">
                            ...
                            <el-button type="text" size="mini" @click="editInterfaceArgv(item)">
                                入参
                            </el-button>
                        ...
                        <template v-if="item.type=='test'">
                            ...
                            <el-button type="text" size="mini" @click="editTestArgv(item)">
                                入参
                            </el-button>
                            <el-button type="text" style="color: red" size="mini" @click="remove(index)">
                                删除
                        ...
                        <template v-if="item.type=='ifbegin'">
                            <el-button type="text" size="mini" @click="editIfBegin(item)">
                                编辑
                            </el-button>
                            <el-button type="text" style="color: red" size="mini" @click="remove(index)">
                                删除
                        ...
                        <template v-if="item.type=='elseif'">
                            <el-button type="text" size="mini" @click="editElseIf(item)">
                                编辑
                            </el-button>
                            <el-button type="text" style="color: red" size="mini" @click="remove(index)">
                                删除
                        ...
                        <template v-if="item.type=='var'">
                            <el-button type="text" size="mini" @click="editVar(item)">
                                编辑
                            </el-button>
                            <el-button type="text" style="color: red" size="mini" @click="remove(index)">
                                删除
                        ...
                        <template v-if="item.type=='return'">
                            <el-button type="text" size="mini" @click="editReturn(item)">
                                编辑
                            </el-button>
                            <el-button type="text" style="color: red" size="mini" @click="remove(index)">
                                删除
                        ...
                        <template v-if="item.type=='log'">
                            <el-button type="text" size="mini" @click="editLog(item)">
                                编辑
                            </el-button>
                            <el-button type="text" style="color: red" size="mini" @click="remove(index)">
                                删除
                        ...
                        <template v-if="item.type=='input'">
                            <el-button type="text" size="mini" @click="editInput(item)">
                                编辑
                            </el-button>
                            <el-button type="text" style="color: red" size="mini" @click="remove(index)">
                                删除
                        ...
                        <template v-if="item.type=='baseurl'">
                            <el-button type="text" size="mini" @click="editBaseUrl(item)">
                                编辑
                            </el-button>
                            <el-button type="text" style="color: red" size="mini" @click="remove(index)">
                                删除
    ...
    module.exports = {
        ...
        methods: {
            ...
            editInterface:function (item,index) {
                ...
                Promise.all([
                    ...
                    if(obj1.code==200 && obj2.code==200)
                    {
                        if(obj3.code==200)
                        {
                            var index1=helper.handleTestInterface(objInterface,obj3.data,obj2.data);
                            var child=$.showBox(_this,require("./testInterfaceRun.vue"),{
            ...
            getTypeName:function (type,item) {
                ...
                {
                    return "<span style='color: orange'>用例</span>"
                }
                else if(type=="ifbegin" || type=="elseif" || type=="else" || type=="ifend")
                {
                    return "<span style='color: green'>条件控制</span>"
                }
                else if(type=="var")
                {
            ...
            editInterfaceArgv:function (item) {
                $.showBox(this,require("./testUIInterfaceArgv.vue"),{
                    argv:item.argv
                })
            },
            editTestArgv:function (item) {
            ...
            insertElseIf:function () {
                var _this=this;
                $.input("输入elseif判断的语句",function (val) {
                    if(!val.value)
                    {
                        $.tip("请输入elseif判断的语句",0);
                        return;
                    }
                    _this.arr.push({
                        type:"elseif",
            ...
            insertLog:function () {
                var _this=this;
                $.input("输入需要打印的值或JS语句",function (val) {
                    if(!val.value)
                    {
                        $.tip("请输入需要打印的值或JS语句",0);
                        return;
                    }
                    _this.arr.push({
                        type:"log",
            ...
            insertInput:function () {
                var _this=this;
                $.inputTwo(this,"标题","提示内容","输入标题","输入提示值或语句","","",function (title,content) {
                    _this.arr.push({
                        type:"input",
                        data:content,
                        id:_this.getNewId(),
            ...
            editInput:function (item) {
                var _this=this;
                $.inputTwo(this,"标题","提示内容","输入标题","输入提示值或语句",item.name,item.data,function (title,content) {
                    item.name=title;
                    item.data=content;
                    return true;
                })
            ...
            insertBaseUrl:function () {
                var _this=this;
                $.input("请输入BaseUrl",function (val) {
                    if(!val.value)
                    {
                        $.tip("请输入BaseUrl",0);
                        return;
                    }
                    var name=$.trim(val.value);
                    if(/^(\"|\').*(\"|\')$/.test(name))
                    {
